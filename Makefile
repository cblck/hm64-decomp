...
MACROS := -D_LANGUAGE_C -D_MIPS_SZLONG=32 -D_MIPS_SZINT=32 -DSUPPORT_NAUDIO -DNU_SYSTEM -DF3DEX_GBI_2 -DNDEBUG
...
DEBUG_FLAGS := -g2
OPTFLAGS := -O2
LIBULTRA_OPTFLAGS := -O3 -DBUILD_VERSION=7 -funsigned-char
LIBKMC_OPTFLAGS := -O1
NU_OPTFLAGS := -O2
