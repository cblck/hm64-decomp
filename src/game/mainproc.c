...
//INCLUDE_ASM(const s32, "game/mainproc", func_80025D90);
...
//INCLUDE_ASM(const s32, "game/mainproc", initializeEngine);
...
//INCLUDE_ASM(const s32, "game/mainproc", func_80025F04);
