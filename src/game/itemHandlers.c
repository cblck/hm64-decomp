...
//INCLUDE_ASM(const s32, "game/itemHandlers", func_800CF850);
...
// jtbl_801222B0
//INCLUDE_ASM(const s32, "game/itemHandlers", getToolLevel);
...
//INCLUDE_ASM(const s32, "game/itemHandlers", func_800CF8F8);
...
//INCLUDE_ASM(const s32, "game/itemHandlers", func_800CFB38);
...
//INCLUDE_ASM(const s32, "game/itemHandlers", func_800CFD78);

void func_800CFD78(u8 spriteIndexOffset, u8 arg1) {
    func_8002F2FC(spriteIndexOffset + 0x27, arg1);
}

//INCLUDE_ASM(const s32, "game/itemHandlers", func_800CFDA0);

void func_800CFDA0(u8 spriteIndexOffset) {
    func_8002FA2C(spriteIndexOffset + 0x27);
}

INCLUDE_ASM(const s32, "game/itemHandlers", func_800CFDC4);

INCLUDE_ASM(const s32, "game/itemHandlers", func_800CFF1C);

INCLUDE_ASM(const s32, "game/itemHandlers", func_800D0074);

// jtbl_801222C8
//INCLUDE_ASM(const s32, "game/itemHandlers", handleToolUse);
...
//INCLUDE_ASM(const s32, "game/itemHandlers", func_800D0318);
...
INCLUDE_ASM(const s32, "game/itemHandlers", func_800D0360);

INCLUDE_ASM(const s32, "game/itemHandlers", func_800D093C);

INCLUDE_ASM(const s32, "game/itemHandlers", func_800D0DD4);

INCLUDE_ASM(const s32, "game/itemHandlers", func_800D1DB0);

INCLUDE_ASM(const s32, "game/itemHandlers", func_800D304C);

//INCLUDE_ASM(const s32, "game/itemHandlers", func_800D3694);
...
//INCLUDE_ASM(const s32, "game/itemHandlers", func_800D36BC);
...
//INCLUDE_ASM(const s32, "game/itemHandlers", func_800D36E4);
...
//INCLUDE_ASM(const s32, "game/itemHandlers", func_800D3714);
...
//INCLUDE_ASM(const s32, "game/itemHandlers", func_800D373C);
...
//INCLUDE_ASM(const s32, "game/itemHandlers", func_800D3958);
...
//INCLUDE_ASM(const s32, "game/itemHandlers", func_800D3B74);
...
//INCLUDE_ASM(const s32, "game/itemHandlers", func_800D3D90);
...
//INCLUDE_ASM(const s32, "game/itemHandlers", func_800D3FAC);
...
//INCLUDE_ASM(const s32, "game/itemHandlers", func_800D41C8);
...
//INCLUDE_ASM(const s32, "game/itemHandlers", func_800D43E4);
...
//INCLUDE_ASM(const s32, "game/itemHandlers", func_800D45F4);
...
//INCLUDE_ASM(const s32, "game/itemHandlers", func_800D4814);
...
//INCLUDE_ASM(const s32, "game/itemHandlers", func_800D4A34);
...
//INCLUDE_ASM(const s32, "game/itemHandlers", func_800D4C28);
...
//INCLUDE_ASM(const s32, "game/itemHandlers", func_800D4CC0);
...
//INCLUDE_ASM(const s32, "game/itemHandlers", func_800D4CD0);
...
//INCLUDE_ASM(const s32, "game/itemHandlers", func_800D4D1C);
...
//INCLUDE_ASM(const s32, "game/itemHandlers", func_800D4D68);
...
INCLUDE_RODATA(const s32, "game/itemHandlers", D_80122340);

INCLUDE_RODATA(const s32, "game/itemHandlers", D_80122344);

INCLUDE_RODATA(const s32, "game/itemHandlers", D_80122348);

INCLUDE_RODATA(const s32, "game/itemHandlers", D_8012234C);

INCLUDE_RODATA(const s32, "game/itemHandlers", D_80122350);

INCLUDE_RODATA(const s32, "game/itemHandlers", D_8012235C);

INCLUDE_RODATA(const s32, "game/itemHandlers", D_80122368);

//INCLUDE_RODATA(const s32, "game/itemHandlers", D_80122374);

const u8 D_80122374[12] = { 5, 4, 3, 6, 8, 2, 7, 0, 1, 0, 0, 0 };
 
//INCLUDE_ASM(const s32, "game/itemHandlers", handleBlueFeatherUse);
...
//INCLUDE_ASM(const s32, "game/itemHandlers", func_800D5130);
...
//INCLUDE_ASM(const s32, "game/itemHandlers", func_800D51B0);
...
//INCLUDE_ASM(const s32, "game/itemHandlers", func_800D5290);
...
//INCLUDE_ASM(const s32, "game/itemHandlers", func_800D5308);
...
//INCLUDE_ASM(const s32, "game/itemHandlers", func_800D5390);
...
//INCLUDE_ASM(const s32, "game/itemHandlers", func_800D5488);
...
//INCLUDE_ASM(const s32, "game/itemHandlers", func_800D5548);
...
//INCLUDE_ASM(const s32, "game/itemHandlers", func_800D55B8);

u16 func_800D55B8(u8 index) {
    return itemInfo[index].unk_28;
}

//INCLUDE_ASM(const s32, "game/itemHandlers", func_800D55E4);
...
//INCLUDE_ASM(const s32, "game/itemHandlers", func_800D5628);
...
//INCLUDE_ASM(const s32, "game/itemHandlers", func_800D5688);
...
INCLUDE_ASM(const s32, "game/itemHandlers", func_800D56E8);

u16 func_800D5A6C(u16 index) {
    return itemFlags[index];
}

//INCLUDE_ASM(const s32, "game/itemHandlers", func_800D5A88);
...
//INCLUDE_ASM(const s32, "game/itemHandlers", func_800D5B00);

u8 func_800D5B00(u16 index) {
    return D_80118540[index];
}

//INCLUDE_ASM(const s32, "game/itemHandlers", func_800D5B18);

u8 func_800D5B18(u16 index) {
    return D_80118620[index];
}

INCLUDE_ASM(const s32, "game/itemHandlers", func_800D5B30);

INCLUDE_ASM(const s32, "game/itemHandlers", func_800D5CC0);

//INCLUDE_ASM(const s32, "game/itemHandlers", func_800D67E4);

u8 func_800D67E4(u8 index) {
    return D_80117F20[index];
}

//INCLUDE_ASM(const s32, "game/itemHandlers", func_800D67FC);
...
//INCLUDE_ASM(const s32, "game/itemHandlers", func_800D6868);
...
//INCLUDE_ASM(const s32, "game/itemHandlers", func_800D6B28);
...
//INCLUDE_ASM(const s32, "game/itemHandlers", func_800D6B58);
...
// jtbl_80122708
INCLUDE_ASM(const s32, "game/itemHandlers", func_800D7010);
