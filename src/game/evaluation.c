...
//INCLUDE_ASM(const s32, "game/evaluation", calculateNPCAffectionScore);
...
//INCLUDE_ASM(const s32, "game/evaluation", calculateHouseExtensionScore);
...
//INCLUDE_ASM(const s32, "game/evaluation", calculateFieldScore);
...
//INCLUDE_ASM(const s32, "game/evaluation", calculateShippingScore);
