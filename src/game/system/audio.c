...
//INCLUDE_ASM(const s32, "game/system/audio", initializeAudio);
...
//INCLUDE_ASM(const s32, "game/system/audio", mainLoopAudioHandler);
...
//INCLUDE_ASM(const s32, "game/system/audio", setSongBank);
...
//INCLUDE_ASM(const s32, "game/system/audio", setSong);
...
//INCLUDE_ASM(const s32, "game/system/audio", setSongSpeed);
...
//INCLUDE_ASM(const s32, "game/system/audio", stopSong);
...
//INCLUDE_ASM(const s32, "game/system/audio", setSongVolumes);
...
//INCLUDE_ASM(const s32, "game/system/audio", func_8003D4E4);
...
//INCLUDE_ASM(const s32, "game/system/audio", func_8003D570);
...
//INCLUDE_ASM(const s32, "game/system/audio", stopMusic);

void stopMusic(int speed) {
    MusStop(MUSFLAG_SONGS, speed);
}

//INCLUDE_ASM(const s32, "game/system/audio", setSfx);
...
//INCLUDE_ASM(const s32, "game/system/audio", func_8003D6A8);
...
//INCLUDE_ASM(const s32, "game/system/audio", setSfxVolume);
...
//INCLUDE_ASM(const s32, "game/system/audio", setSfxFrequency);
...
//INCLUDE_ASM(const s32, "game/system/audio", setSfxPan);
...
//INCLUDE_ASM(const s32, "game/system/audio", stopSoundEffect);
