...
//INCLUDE_ASM(const s32, "game/system/audioUtils", func_800266C0);
...
//INCLUDE_ASM(const s32, "game/system/audioUtils", func_800266F8);
...
//INCLUDE_ASM(const s32, "game/system/audioUtils", func_800267A4);
...
//INCLUDE_ASM(const s32, "game/system/audioUtils", func_800267B4);
...
//INCLUDE_ASM(const s32, "game/system/audioUtils", func_8002683C);

void func_8002683C(Volume* volumePtr, s16 arg1) {
    volumePtr->unk_4 = arg1;
}

//INCLUDE_ASM(const s32, "game/system/audioUtils", func_80026844);

s16 func_80026844(Volume *volumePtr) {
    return volumePtr->unk_4;
}

// alternate if used with a different/generic struct (used by dialogue box struct)
/*
