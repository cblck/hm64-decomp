...
//INCLUDE_RODATA(const s32, "game/system/graphic", D_8011EC40);

//INCLUDE_ASM(const s32, "game/system/graphic", graphicsInit);
...
//INCLUDE_ASM(const s32, "game/system/graphic", drawFrame);
...
//INCLUDE_ASM(const s32, "game/system/graphic", startGfxTask);
...
//INCLUDE_ASM(const s32, "game/system/graphic", doViewportGfxTask);
...
//INCLUDE_ASM(const s32, "game/system/graphic", func_80026CEC);
...
//INCLUDE_ASM(const s32, "game/system/graphic", setBitmapFormat);
...
//INCLUDE_ASM(const s32, "game/system/graphic", func_80026F30);
...
//INCLUDE_ASM(const s32, "game/system/graphic", func_80026F88);
...
//INCLUDE_ASM(const s32, "game/system/graphic", func_800276AC);
...
//INCLUDE_ASM(const s32, "game/system/graphic", sinfRadians);

f32 sinfRadians(f32 angle) {
    return sinf(angle * DEGREES_TO_RADIANS_CONSTANT);
}

//INCLUDE_ASM(const s32, "game/system/graphic", cosfRadians);

f32 cosfRadians(f32 angle) {
    return cosf(angle * DEGREES_TO_RADIANS_CONSTANT);
}

//INCLUDE_ASM(const s32, "game/system/graphic", func_80027950);
...
//INCLUDE_ASM(const s32, "game/system/graphic", func_80027B74);
...
//INCLUDE_ASM(const s32, "game/system/graphic", func_80027BFC);
...
//INCLUDE_ASM(const s32, "game/system/graphic", func_80027DC0);
...
//INCLUDE_ASM(const s32, "game/system/graphic", func_80027E10);
...
//INCLUDE_ASM(const s32, "game/system/graphic", func_800284E8);
...
//INCLUDE_RODATA(const s32, "game/system/graphic", directionsToYValues);

static const f32 directionsToYValues[8] = { 0.0f, 315.0f, 270.0f, 225.0f, 180.0f, 135.0f, 90.0f, 45.0f };

//INCLUDE_ASM(const s32, "game/system/graphic", func_80028520);
...
//INCLUDE_ASM(const s32, "game/system/graphic", getSpriteYValueFromDirection);
...
//INCLUDE_ASM(const s32, "game/system/graphic", func_80028888);
...
//INCLUDE_ASM(const s32, "game/system/graphic", func_800288A0);
...
//INCLUDE_ASM(const s32, "game/system/graphic", func_800288B8);
...
//INCLUDE_ASM(const s32, "game/system/graphic", initRcp);
...
//INCLUDE_ASM(const s32, "game/system/graphic", clearFramebuffer);
...
//INCLUDE_ASM(const s32, "game/system/graphic", func_80028A64);
...
//INCLUDE_ASM(const s32, "game/system/graphic", func_80028C00);
...
//INCLUDE_ASM(const s32, "game/system/graphic", setCameraOrthographicValues);
...
//INCLUDE_ASM(const s32, "game/system/graphic", setCameraPerspectiveValues);
...
//INCLUDE_ASM(const s32, "game/system/graphic", setCameraLookAt);
...
//INCLUDE_ASM(const s32, "game/system/graphic", func_80028E14);
...
//INCLUDE_ASM(const s32, "game/system/graphic", func_80028E60);
...
//INCLUDE_ASM(const s32, "game/system/graphic", func_80028EA8);
...
//INCLUDE_ASM(const s32, "game/system/graphic", setInitialWorldRotationAngles);
...
//INCLUDE_ASM(const s32, "game/system/graphic", func_80028EF8);
...
//INCLUDE_ASM(const s32, "game/system/graphic", nuGfxInit);
