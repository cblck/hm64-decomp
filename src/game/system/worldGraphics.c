...
//INCLUDE_ASM(const s32, "game/system/worldGraphics", initializeWorldGraphics);
...
//INCLUDE_ASM(const s32, "game/system/worldGraphics", resetSpriteCounter);
...
//INCLUDE_ASM(const s32, "game/system/worldGraphics", func_8002929C);
...
//INCLUDE_ASM(const s32, "game/system/worldGraphics", func_800292EC);
...
//INCLUDE_ASM(const s32, "game/system/worldGraphics", func_80029330);
...
//INCLUDE_ASM(const s32, "game/system/worldGraphics", func_80029374);
...
//INCLUDE_ASM(const s32, "game/system/worldGraphics", func_800293C0);
