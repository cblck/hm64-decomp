...
//INCLUDE_ASM(const s32, "game/system/memory", sramInit);
...
//INCLUDE_ASM(const s32, "game/system/memory", func_8004DC48);
...
//INCLUDE_ASM(const s32, "game/system/memory", func_8004DD7C);
