...
//INCLUDE_ASM(const s32, "game/system/controller", controllerInit);
...
//INCLUDE_ASM(const s32, "game/system/controller", func_8004CF68);
...
//INCLUDE_ASM(const s32, "game/system/controller", func_8004D788);
...
//INCLUDE_ASM(const s32, "game/system/controller", func_8004D87C);

s32 func_8004D87C(u8 contIndex) {
    return nuContPakGetFree(&controllers[contIndex].pak);
}

//INCLUDE_ASM(const s32, "game/system/controller", func_8004D8B4);
...
//INCLUDE_ASM(const s32, "game/system/controller", func_8004D904);
...
//INCLUDE_ASM(const s32, "game/system/controller", func_8004D954);
...
//INCLUDE_ASM(const s32, "game/system/controller", func_8004D9AC);
...
//INCLUDE_ASM(const s32, "game/system/controller", func_8004DA48);
...
//INCLUDE_ASM(const s32, "game/system/controller", func_8004DAF4);
