...
//INCLUDE_ASM(const s32, "game/system/map", func_800337D0);
...
//INCLUDE_ASM(const s32, "game/system/map", func_80033A90);
...
bool func_80033A90(u16 mapIndex, LevelMapContext* arg1, void* arg2, void* arg3, void* arg4, void* arg5, void* arg6, void* arg7, void* arg8, void* arg9, void *argA) {
    ...
    if (mapIndex == MAIN_MAP_INDEX && !(mainMap[mapIndex].mapStruct9.flags & MAP_ACTIVE)) {
        ...
        mainMap[mapIndex].mapStruct9.mapObjectCount = 0;
        ...
        temp1 = mainMap[mapIndex].mapStruct1.unk_A / 2;
        temp2 = mainMap[mapIndex].mapStruct1.unk_B / 2;
...
//INCLUDE_ASM(const s32, "game/system/map", func_80034090);
...
bool func_80034090(u16 mapIndex) {
    ...
    if (mapIndex == MAIN_MAP_INDEX && (mainMap[mapIndex].mapStruct9.flags & MAP_ACTIVE)) {
        ...
        for (i = 0; i < 0x10; i++) {
            ...
            if (mainMap[mapIndex].mapObjects[i].flags & OBJECT_ACTIVE) {
        ...
        for (i = 0; i < 0x10; i++) { 
            ...
            if (mainMap[mapIndex].weatherSprites[i].flags & SPRITE_ACTIVE) {
...
//INCLUDE_ASM(const s32, "game/system/map", setMapTranslation);
...
//INCLUDE_ASM(const s32, "game/system/map", func_80034298);
...
//INCLUDE_ASM(const s32, "game/system/map", setMapRotation);
...
//INCLUDE_ASM(const s32, "game/system/map", setMapRGBA);
...
//INCLUDE_ASM(const s32, "game/system/map", func_800343FC);
...
//INCLUDE_ASM(const s32, "game/system/map", adjustMapTranslation);
...
//INCLUDE_ASM(const s32, "game/system/map", adjustMapScale);
...
//INCLUDE_ASM(const s32, "game/system/map", adjustMapRotation);
...
//INCLUDE_ASM(const s32, "game/system/map", adjustMapRGBA);
...
//INCLUDE_ASM(const s32, "game/system/map", func_80034738);
...
//INCLUDE_ASM(const s32, "game/system/map", func_80034A6C);
...
//INCLUDE_ASM(const s32, "game/system/map", setMapObject);
...
bool setMapObject(u16 mapIndex, u8 index, u16 spriteIndex, u16 arg3, f32 x, f32 y, f32 z, u8 arg7, u8 arg8, u8 arg9, u8 argA) {
    ...
    if (mapIndex == MAIN_MAP_INDEX && (mainMap[mapIndex].mapStruct9.flags & MAP_ACTIVE)) {
        ...
        mainMap[mapIndex].mapStruct9.mapObjectCount++;
...
//INCLUDE_ASM(const s32, "game/system/map", func_80034D64);
...
//INCLUDE_ASM(const s32, "game/system/map", func_80034DC8);
...
//INCLUDE_ASM(const s32, "game/system/map", deactivateMapObject);
...
//INCLUDE_ASM(const s32, "game/system/map", func_80034EF0);
...
//INCLUDE_ASM(const s32, "game/system/map", func_80035004);
...
//INCLUDE_ASM(const s32, "game/system/map", func_80035054);
...
INCLUDE_ASM(const s32, "game/system/map", func_80035150);

//INCLUDE_ASM(const s32, "game/system/map", func_8003544C);
...
//INCLUDE_ASM(const s32, "game/system/map", func_80035914);
...
//INCLUDE_ASM(const s32, "game/system/map", func_800359C8);
...
//INCLUDE_ASM(const s32, "game/system/map", func_80035A58);
...
//INCLUDE_ASM(const s32, "game/system/map", func_80035DA4);
...
// unused or inline
INCLUDE_ASM(const s32, "game/system/map", func_80035EE0);

// mapStruct1, vertices for map additions (house extensions, hot springs, etc.)
INCLUDE_ASM(const s32, "game/system/map", func_800360BC);

// returns index for interactable object/exit from rodata array per level
INCLUDE_ASM(const s32, "game/system/map", func_80036318);
...
#else
INCLUDE_ASM(const s32, "game/system/map", func_80036490);
#endif

//INCLUDE_ASM(const s32, "game/system/map", func_80036610);
...
//INCLUDE_ASM(const s32, "game/system/map", func_800366F4);
...
//INCLUDE_ASM(const s32, "game/system/map", func_80036880);
...
//INCLUDE_ASM(const s32, "game/system/map", func_80036980);
...
//INCLUDE_ASM(const s32, "game/system/map", checkMapRGBADone);
...
//INCLUDE_ASM(const s32, "game/system/map", func_80036AB4);
...
INCLUDE_ASM(const s32, "game/system/map", func_80036C08);

INCLUDE_ASM(const s32, "game/system/map", func_80036FA0);

INCLUDE_ASM(const s32, "game/system/map", func_80037254);
...
#else
INCLUDE_ASM(const s32, "game/system/map", func_800372F0);
#endif

//INCLUDE_ASM(const s32, "game/system/map", func_80037350);
...
#else
INCLUDE_ASM(const s32, "game/system/map", func_80037388);
#endif

INCLUDE_ASM(const s32, "game/system/map", func_80037400);

INCLUDE_ASM(const s32, "game/system/map", func_800374C0);

//INCLUDE_ASM(const s32, "game/system/map", func_80037614);
...
//INCLUDE_ASM(const s32, "game/system/map", func_80037650);
...
//INCLUDE_ASM(const s32, "game/system/map", func_80037668);
...
//INCLUDE_ASM(const s32, "game/system/map", func_8003797C);

Gfx* func_8003797C(Gfx* dl, MainMap* map, u8 arg2) {

    Tile bitmap;

    setBitmapFormat((HMBitmap*)&bitmap, func_80028888(arg2, map->unk_10), func_800288A0(arg2, map->unk_14));
...
// uses gSPVertex
// calls func_800383B0
INCLUDE_ASM(const s32, "game/system/map", func_80037BC4);

//INCLUDE_ASM(const s32, "game/system/map", func_80037DF0);
...
// vertex coloring
INCLUDE_ASM(const s32, "game/system/map", func_80037F08);

//INCLUDE_ASM(const s32, "game/system/map", func_800383B0);
...
//INCLUDE_ASM(const s32, "game/system/map", func_8003851C);
...
//INCLUDE_ASM(const s32, "game/system/map", func_80038630);
...
//INCLUDE_ASM(const s32, "game/system/map", func_800386C0);
...
#else
INCLUDE_ASM(const s32, "game/system/map", func_800386D4);
#endif

//INCLUDE_ASM(const s32, "game/system/map", func_80038728);
...
//INCLUDE_ASM(const s32, "game/system/map", func_800387E0);

u32* func_800387E0(u16 arg0, u32* arg1) {
    return (u8*)arg1 + arg1[arg0];
}

//INCLUDE_ASM(const s32, "game/system/map", func_800387F8);

u32* func_800387F8(u16 arg0, u32* arg1) {
    return (u8*)arg1 + arg1[arg0];
}

//INCLUDE_ASM(const s32, "game/system/map", func_80038810);
...
//INCLUDE_ASM(const s32, "game/system/map", func_8003886C);
...
//INCLUDE_ASM(const s32, "game/system/map", func_800388A4);
...
//INCLUDE_ASM(const s32, "game/system/map", func_80038900);
...
//INCLUDE_ASM(const s32, "game/system/map", func_80038990);

bool func_80038990(u16 mapIndex, u16 mapAdditionIndex, u8 arg2) {

    bool result = FALSE;

    if (mapIndex == MAIN_MAP_INDEX && mainMap[mapIndex].mapStruct9.flags & MAP_ACTIVE && mapAdditionIndex < 0x20) {
...
//INCLUDE_ASM(const s32, "game/system/map", func_80038A2C);
...
//INCLUDE_ASM(const s32, "game/system/map", func_80038AE0);
...
//INCLUDE_ASM(const s32, "game/system/map", func_80038B58);
...
INCLUDE_ASM(const s32, "game/system/map", func_80038BC4);

INCLUDE_ASM(const s32, "game/system/map", func_800393E0);

INCLUDE_ASM(const s32, "game/system/map", func_80039990);

//INCLUDE_ASM(const s32, "game/system/map", func_80039E00);

//INCLUDE_ASM(const s32, "game/system/map", func_80039E20);
...
//INCLUDE_ASM(const s32, "game/system/map", func_80039F58);
...
//INCLUDE_ASM(const s32, "game/system/map", func_8003A1BC);
...
void func_8003A1BC(void) {
    ...
    for (i = 0; i < MAX_MAPS; i++) {
        ...
        if ((mainMap[i].mapStruct9.flags & MAP_ACTIVE) && (mainMap[i].mapStruct9.flags & 2)) {
...
//INCLUDE_ASM(const s32, "game/system/map", func_8003AC14);
...
//INCLUDE_ASM(const s32, "game/system/map", func_8003ACA8);
...
//INCLUDE_ASM(const s32, "game/system/map", func_8003AF58);
...
//INCLUDE_ASM(const s32, "game/system/map", func_8003B100);
...
//INCLUDE_RODATA(const s32, "game/system/map", D_8011EDA0);

static const Gfx D_8011EDA8 = gsDPPipeSync();

//INCLUDE_RODATA(const s32, "game/system/map", D_8011EDA8);

//INCLUDE_RODATA(const s32, "game/system/map", D_8011EDB0);

//INCLUDE_RODATA(const s32, "game/system/map", D_8011EDB4);
...
//INCLUDE_RODATA(const s32, "game/system/map", D_8011EDC8);

static const Gfx D_8011EDD0 = gsSPTexture(0x8000, 0x8000, 0, G_TX_RENDERTILE, G_ON);

//INCLUDE_RODATA(const s32, "game/system/map", D_8011EDD0);

static const Gfx D_8011EDD8 = gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0);

//INCLUDE_RODATA(const s32, "game/system/map", D_8011EDD8);
