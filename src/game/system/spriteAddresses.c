...
//INCLUDE_ASM(const s32, "game/system/spriteAddresses", resetSpriteAddressesFlags);
...
//INCLUDE_ASM(const s32, "game/system/spriteAddresses", setSpriteAddresses);
...
//INCLUDE_ASM(const s32, "game/system/spriteAddresses", dmaSprites);
