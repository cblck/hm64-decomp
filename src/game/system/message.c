...
//INCLUDE_ASM(const s32, "game/system/message", func_8003D970);
...
//INCLUDE_ASM(const s32, "game/system/message", func_8003DBE8);
...
//INCLUDE_ASM(const s32, "game/system/message", func_8003DD14);
...
//INCLUDE_ASM(const s32, "game/system/message", initializeDialogueBox);
...
//INCLUDE_ASM(const s32, "game/system/message", func_8003E77C);
...
// rgba
INCLUDE_ASM(const s32, "game/system/message", func_8003E910);

INCLUDE_ASM(const s32, "game/system/message", func_8003EA1C);

//INCLUDE_ASM(const s32, "game/system/message", func_8003EE7C);
...
//INCLUDE_ASM(const s32, "game/system/message", func_8003EFD8);
...
//INCLUDE_ASM(const s32, "game/system/message", func_8003F024);
...
//INCLUDE_ASM(const s32, "game/system/message", func_8003F0DC);
...
INCLUDE_ASM(const s32, "game/system/message", func_8003F130);

INCLUDE_ASM(const s32, "game/system/message", func_8003F28C);

//INCLUDE_ASM(const s32, "game/system/message", setDialogueInfo);
...
INCLUDE_ASM(const s32, "game/system/message", func_8003F360);

//INCLUDE_ASM(const s32, "game/system/message", func_8003F464);
...
INCLUDE_ASM(const s32, "game/system/message", func_8003F4E0);

//INCLUDE_ASM(const s32, "game/system/message", func_8003F54C);
...
//INCLUDE_ASM(const s32, "game/system/message", func_8003F5D0);
...
//INCLUDE_ASM(const s32, "game/system/message", func_8003F630);
...
//INCLUDE_ASM(const s32, "game/system/message", setDialogueBoxSpriteIndices);
...
//INCLUDE_ASM(const s32, "game/system/message", func_8003F80C);
...
//INCLUDE_ASM(const s32, "game/system/message", func_8003F910);
...
//INCLUDE_ASM(const s32, "game/system/message", func_8003FA1C);
...
//INCLUDE_ASM(const s32, "game/system/message", func_8003FAE8);

void func_8003FAE8(void* arg0) {
    D_801891C8 = arg0;
}

//INCLUDE_ASM(const s32, "game/system/message", func_8003FAF8);
...
//INCLUDE_ASM(const s32, "game/system/message", func_8003FB4C);
...
//INCLUDE_ASM(const s32, "game/system/message", setGameVariableString);
...
//INCLUDE_ASM(const s32, "game/system/message", func_8003FBD8);
...
//INCLUDE_ASM(const s32, "game/system/message", func_8003FD74);
...
//INCLUDE_ASM(const s32, "game/system/message", func_8003FDB0);
...
//INCLUDE_ASM(const s32, "game/system/message", func_8003FE9C);
...
//INCLUDE_ASM(const s32, "game/system/message", func_8003FFF4);
...
//INCLUDE_ASM(const s32, "game/system/message", func_80040140);
...
//INCLUDE_ASM(const s32, "game/system/message", func_800401C8);
...
//INCLUDE_ASM(const s32, "game/system/message", func_8004022C);
...
//INCLUDE_ASM(const s32, "game/system/message", func_80040318);
...
//INCLUDE_RODATA(const s32, "game/system/message", D_8011EE10);
...
//INCLUDE_RODATA(const s32, "game/system/message", D_8011EE30);

//INCLUDE_ASM(const s32, "game/system/message", func_800403F0);
...
//INCLUDE_ASM(const s32, "game/system/message", func_80040628);
...
INCLUDE_ASM(const s32, "game/system/message", func_80040858);

INCLUDE_ASM(const s32, "game/system/message", func_80040C38);

//INCLUDE_ASM(const s32, "game/system/message", func_80041850);
...
//INCLUDE_ASM(const s32, "game/system/message", func_800419C4);
...
//INCLUDE_ASM(const s32, "game/system/message", func_80041B28);
...
//INCLUDE_ASM(const s32, "game/system/message", func_80041B80);
...
#else
INCLUDE_ASM(const s32, "game/system/message", func_80041CD8);
#endif
...
#else
INCLUDE_ASM(const s32, "game/system/message", func_80042014);
#endif

INCLUDE_ASM(const s32, "game/system/message", func_800423F0);

static const u8 D_8011EE90[8] = { 0x80, 0x40, 0x20, 0x10, 8, 4, 2, 1, 0 };

//INCLUDE_RODATA(const s32, "game/system/message", D_8011EE90);

static const Gfx D_8011EE98 = gsDPSetCombineMode(G_CC_MODULATEIDECALA, G_CC_MODULATEIDECALA);

//INCLUDE_RODATA(const s32, "game/system/message", D_8011EE98);

static const Gfx D_8011EEA0 = gsDPSetRenderMode(G_RM_TEX_EDGE, G_RM_TEX_EDGE2);

//INCLUDE_RODATA(const s32, "game/system/message", D_8011EEA0);

static const Gfx D_8011EEA8 = gsDPSetTextureFilter(G_TF_BILERP);

//INCLUDE_RODATA(const s32, "game/system/message", D_8011EEA8);

static const Gfx D_8011EEB0 = gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0);

//INCLUDE_RODATA(const s32, "game/system/message", D_8011EEB0);

static const Gfx D_8011EEB8 = gsDPPipeSync();

//INCLUDE_RODATA(const s32, "game/system/message", D_8011EEB8);

static const Gfx D_8011EEC0 = gsSPEndDisplayList();

//INCLUDE_RODATA(const s32, "game/system/message", D_8011EEC0);

// main loop function
INCLUDE_ASM(const s32, "game/system/message", func_80042634);
