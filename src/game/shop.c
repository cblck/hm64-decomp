...
//INCLUDE_ASM(const s32, "game/shop", func_800DC750);
...
//INCLUDE_ASM(const s32, "game/shop", loadShopItemSprite);
...
//INCLUDE_ASM(const s32, "game/shop", func_800DC9C0);
...
//INCLUDE_ASM(const s32, "game/shop", func_800DC9FC);
...
//INCLUDE_ASM(const s32, "game/shop", func_800DCAA0);
...
// jtbl_80123480
//INCLUDE_ASM(const s32, "game/shop", func_800DCAB8);
...
// jtbl_80123498
//INCLUDE_ASM(const s32, "game/shop", handlePurchase);
...
// jtbl_80123578
//INCLUDE_ASM(const s32, "game/shop", checkShopItemShouldBeDisplayed);
