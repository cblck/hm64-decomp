...
//INCLUDE_ASM(const s32, "game/initialize", func_8004E160);
...
//INCLUDE_ASM(const s32, "game/initialize", initializeGameVariables);
...
//INCLUDE_ASM(const s32, "game/initialize", registerMainLoopCallbacks);
...
// sprites
INCLUDE_ASM(const s32, "game/initialize", func_8004F768);

//INCLUDE_ASM(const s32, "game/initialize", loadMapAddresses);
...
INCLUDE_ASM(const s32, "game/initialize", func_80053088);
...
INCLUDE_ASM(const s32, "game/initialize", func_800535DC);
...
//INCLUDE_ASM(const s32, "game/initialize", initializeNameStrings);
...
//INCLUDE_ASM(const s32, "game/initialize", func_80054550);
...
INCLUDE_ASM(const s32, "game/initialize", func_80054734);
