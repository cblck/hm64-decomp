...
//INCLUDE_ASM(const s32, "game/updateGame", func_800D7C20);
...
//INCLUDE_ASM(const s32, "game/updateGame", updateClock);
...
//INCLUDE_ASM(const s32, "game/updateGame", setupNewYear);
...
//INCLUDE_ASM(const s32, "game/updateGame", toggleMonthlyLetterBits);
...
//INCLUDE_ASM(const s32, "game/updateGame", setClockNewDay);
...
//INCLUDE_ASM(const s32, "game/updateGame", checkFestivalDay);
...
//INCLUDE_ASM(const s32, "game/updateGame", setSeasonName);
...
//INCLUDE_ASM(const s32, "game/updateGame", setGlobalSeasonName);
