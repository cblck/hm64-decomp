...
//INCLUDE_ASM(const s32, "game/weather", func_800DC360);
...
//INCLUDE_ASM(const s32, "game/weather", setForecast);
...
//INCLUDE_ASM(const s32, "game/weather", setWeatherLighting);
...
//INCLUDE_RODATA(const s32, "game/weather", D_80123438);
...
//INCLUDE_RODATA(const s32, "game/weather", D_8012344C);
