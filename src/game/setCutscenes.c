...
//INCLUDE_ASM(const s32, "game/setCutscenes", func_8009BF90);
...
// jtbl_80120EC0
//INCLUDE_ASM(const s32, "game/setCutscenes", func_8009C054);
...
// jtbl_80121030
//INCLUDE_ASM(const s32, "game/setCutscenes", func_8009C324);
...
//INCLUDE_ASM(const s32, "game/setCutscenes", setFarmCutscenes);
...
//INCLUDE_ASM(const s32, "game/setCutscenes", setMountain1Cutscenes);
...
// mountain 2
INCLUDE_ASM(const s32, "game/setCutscenes", func_800A1C04);

//INCLUDE_ASM(const s32, "game/setCutscenes", func_800A2250);
...
//INCLUDE_ASM(const s32, "game/setCutscenes", setMoonMountainCutscenes);
...
//INCLUDE_ASM(const s32, "game/setCutscenes", setSpringCutscenes);
...
//INCLUDE_ASM(const s32, "game/setCutscenes", setHarvestSpriteCaveCutscenes);
...
//INCLUDE_ASM(const s32, "game/setCutscenes", setCaveCutscenes);
...
// jtbl_80121048
//INCLUDE_ASM(const s32, "game/setCutscenes", func_800A29B0);
...
// kitchen
//INCLUDE_ASM(const s32, "game/setCutscenes", func_800A2FA8);
...
// ranch
INCLUDE_ASM(const s32, "game/setCutscenes", func_800A3F04);

//INCLUDE_ASM(const s32, "game/setCutscenes", setRanchStoreCutscenes);
...
//INCLUDE_ASM(const s32, "game/setCutscenes", func_800A4878);
...
//INCLUDE_ASM(const s32, "game/setCutscenes", setVineyardHouseCutscenes);
...
//INCLUDE_ASM(const s32, "game/setCutscenes", setVineyardCellarCutscenes);
...
// village 1
INCLUDE_ASM(const s32, "game/setCutscenes", func_800A4E50);

// village 2
INCLUDE_ASM(const s32, "game/setCutscenes", func_800A5314);

//INCLUDE_ASM(const s32, "game/setCutscenes", setRickStoreCutscenes);
...
//INCLUDE_ASM(const s32, "game/setCutscenes", setFlowerShopCutscenes);
...
// bakery
INCLUDE_ASM(const s32, "game/setCutscenes", func_800A5F48);

//INCLUDE_ASM(const s32, "game/setCutscenes", func_800A6440);
...
//INCLUDE_ASM(const s32, "game/setCutscenes", func_800A6634);
...
//INCLUDE_ASM(const s32, "game/setCutscenes", setChurchCutscenes);
...
//INCLUDE_ASM(const s32, "game/setCutscenes", func_800A68C0);
...
u16 func_800A68C0(void) {
    ...
    if (!set && !checkLifeEventBit(KAREN_KAI_TAVERN_CUTSCENE) && npcAffection[KAREN] >= 80 && npcAffection[KAI] >= 80 && (17 < gHour && gHour < 24) && (!checkLifeEventBit(MARRIED) || gWife != KAREN) && !checkLifeEventBit(0x1E)) {
...
// square
INCLUDE_ASM(const s32, "game/setCutscenes", func_800A6A14);

//INCLUDE_ASM(const s32, "game/setCutscenes", func_800A6EE4);
...
//INCLUDE_ASM(const s32, "game/setCutscenes", setBeachCutscenes);
...
//INCLUDE_ASM(const s32, "game/setCutscenes", setRoadCutscenes);
...
//INCLUDE_ASM(const s32, "game/setCutscenes", func_800A7AE8);
...
// jtbl_80121060
// jtbl_80121078
//INCLUDE_ASM(const s32, "game/setCutscenes", func_800A7DFC);
...
// dreams
INCLUDE_ASM(const s32, "game/setCutscenes", func_800A87C4);
...
// jtbl_801213D0
// jtbl_801213F0
INCLUDE_ASM(const s32, "game/setCutscenes", func_800A8F74);

INCLUDE_ASM(const s32, "game/setCutscenes", loadCutscene);