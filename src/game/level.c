...
//INCLUDE_ASM(const s32, "game/level", setEntrance);
...
//INCLUDE_ASM(const s32, "game/level", func_8006E840);
...
//INCLUDE_ASM(const s32, "game/level", setLevelGraphicsData);
...
//INCLUDE_ASM(const s32, "game/level", setLevelAudio);
...
//INCLUDE_ASM(const s32, "game/level", func_8006EB94);
...
//INCLUDE_ASM(const s32, "game/level", getLevelFlags);

u8 getLevelFlags(u16 mapIndex) {
    return levelFlags[mapIndex];
}

//INCLUDE_ASM(const s32, "game/level", func_8006EC58);
...
//INCLUDE_ASM(const s32, "game/level", func_8006F938);
...
//INCLUDE_ASM(const s32, "game/level", func_80073244);
...
//INCLUDE_ASM(const s32, "game/level", func_8007341C);
...
INCLUDE_RODATA(const s32, "game/level", D_8011FB28);

INCLUDE_RODATA(const s32, "game/level", D_8011FB70);
...
INCLUDE_ASM(const s32, "game/level", func_800735FC);
...
//INCLUDE_ASM(const s32, "game/level", setAdditionalMapAdditionsForLevel);
...
//INCLUDE_ASM(const s32, "game/level", func_80074C38);
...
//INCLUDE_ASM(const s32, "game/level", func_80074C50);
