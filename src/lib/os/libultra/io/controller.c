...
extern OSPifRam __osContPifRam ALIGNED(16);
extern u8 __osContLastCmd;
extern u8 __osMaxControllers;

extern OSTimer __osEepromTimer;
extern OSMesgQueue __osEepromTimerQ ALIGNED(8);
extern OSMesg __osEepromTimerMsg;

//INCLUDE_RODATA(const s32, "lib/os/libultra/io/controller", __osContinitialized);
...
//INCLUDE_ASM(const s32, "lib/os/libultra/io/controller", __osPackRequestData);
